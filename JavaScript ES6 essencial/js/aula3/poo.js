//Para executar os códigos deixar tudo comentado exceto o código desejado
'use strict';
...
const p = new Pessoa('Silas');
console.log(p);
//Pessoa {name: Silas}, constructor: f Pessoa (name), __proto__:Object
function Pessoa(name){
    this.name = name;
    return{
        name: 'Teste'
